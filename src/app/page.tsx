      ...
      <div className="min-h-screen bg-gradient-to-b from-background to-background/80 p-4 sm:p-6 md:p-8 relative pt-16">
        ...
        <div className="max-w-5xl mx-auto space-y-8 relative z-10">
          <header className="text-center space-y-4">
            ...
            {/*
              One statement across two lines: the subhead continues the
              headline, so both share the same size, weight and colour. The
              subhead keeps aria-hidden off and stays a <p> for semantics, but
              visually it reads as one thought.
            */}
